    ...
    return (
      <Container>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          <LinearGradient colors={LGColor} useAngle={true} angle={90} angleCenter={{ x: 0.5, y: 0 }} style={styles.linearGrad}>
            <TouchableOpacity
              onPress={() =>
              ...
              <Flex style={styles.titleFlex}>
                ...
                <View style={styles.titleUser}>
                  <Text style={styles.titleText}>{this.props.store.settings.username || 'User'}</Text>
                  <Text style={styles.titleEmail}>{this.props.store.settings.email}</Text>
                </View>
              </Flex>
            </TouchableOpacity>
          </LinearGradient>
