...
class SendCoin extends React.Component {
  ...
  validateGas = () => {
    ...
    const { transaction: { gas, gasPrice, value, from } } = this.props.transaction;
    let errorMessage;
      ...
      <Container style={styles.container}>
        ...
        <KeyboardAwareScrollView
          ...
          <Flex justify={'between'} style={styles.amountFlex}>
            <TextInput style={styles.amountInput} numberOfLines={1}
            ...
            />
            <Text style={{ fontSize: 15, color: '#C4CAD2' }}>
              {coin.name}
            </Text>
          </Flex>
          <Flex justify={'between'} style={styles.amountFlex}>
          ...
          <Flex
            justify={'between'}
            style={styles.fee}>
            <Text styles={styles.assetMidText}>
            Gas Fee
            </Text>
            <Text styles={styles.assetMidText}>0</Text>
          </Flex>
          <Button
            type="primary"
            onPress={() => {
