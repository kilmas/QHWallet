        ...
        <View style={[styles.selectWrapper, highlighted ? styles.borderHighlighted : styles.borderOpaque]}>
          ...
          {!!onScan && (
            <TouchableOpacity onPress={onScan} style={styles.iconWrapper}>
              <Icon name="scan" size={20} style={[styles.scanIcon, highlighted ? styles.iconHighlighted : styles.iconOpaque]} />
            </TouchableOpacity>
          )}
        </View>
      ) : (
        <View style={[styles.selectWrapper, highlighted ? styles.borderHighlighted : styles.borderOpaque]}>
              ...
              <View style={[styles.address, styles.checkAddress]}>
                ...
                <View style={styles.addressWrapper}>
                  ...
                  <View style={(styles.checkIconWrapper, toAddressName ? {} : { paddingTop: 2 })}>
                    <Icon name="check" color={colors.green600} size={15} />
                  </View>
                </View>
              </View>
            </View>
          ...
          {!!onClear && (
            <TouchableOpacity onPress={onClear} style={styles.iconWrapper} testID={'clear-address-button'}>
              <Icon name="close" size={20} style={[styles.scanIcon, highlighted ? styles.iconHighlighted : styles.iconOpaque]} />
            </TouchableOpacity>
          )}
        </View>
      )}
    ...
    <View style={styles.wrapper}>
      ...
      <View style={[styles.inputWrapper, highlighted ? styles.borderHighlighted : styles.borderOpaque]}>
        ...
        <View style={[baseStyles.flexGrow, styles.address]}>
          ...
          <Text style={styles.textBalance}>{`${strings('transactions.address_from_balance')} ${fromAccountBalance}`}</Text>
        </View>

        {!!onPressIcon && (
          <TouchableOpacity onPress={onPressIcon} style={styles.iconWrapper}>
            <View style={styles.dropdownIconWrapper}>
              <Icon name={'caret-down'} size={20} style={[styles.dropdownIcon, highlighted ? styles.iconHighlighted : styles.iconOpaque]} />
            </View>
          </TouchableOpacity>
        )}
      </View>
