...
import { fromWei, renderWei, hexToBN, renderFromWei, isBN, isDecimal } from '../../../utils/number'
 ...
 */
class CustomGas extends React.Component {
  static propTypes = {
    /**
  ...
  onGasLimitChange = value => {
    ...
    else if (bnValue.lt(new BN(21000)) || bnValue.gt(new BN(7920028))) warningGasLimit = strings('custom_gas.warning_gas_limit')
  ...
  renderCustomGasSelector = () => {
    const { averageGwei, safeLowGwei, fastGwei, gasSlowSelected, gasAverageSelected, gasFastSelected, averageWait, safeLowWait, fastWait } = this.state
    return (
      <View style={styles.selectors}>
        {this.renderGasSelector('slow', safeLowGwei, gasSlowSelected, safeLowWait, this.onPressGasSlow)}
        {this.renderGasSelector('average', averageGwei, gasAverageSelected, averageWait, this.onPressGasAverage)}
    ...
    return (
      <View style={styles.advancedOptionsContainer}>
        ...
        <View style={styles.valueRow}>
          ...
          <TextInput keyboardType="numeric" style={styles.gasInput} onChangeText={this.onGasLimitChange} value={customGasLimit} />
        </View>
        <View style={styles.valueRow}>
          <Text style={styles.advancedOptionsText}>{strings('custom_gas.gas_price')}</Text>
          <TextInput keyboardType="numeric" style={styles.gasInput} onChangeText={this.onGasPriceChange} value={customGasPrice} />
        </View>
      </View>
    )
  }
      ...
      return (
        <View style={styles.root}>
          ...
          <View style={styles.optionsContainer}>
            ...
            <TouchableOpacity style={[styles.basicButton, advancedCustomGas ? styles.optionSelected : null]} onPress={this.onAdvancedOptions}>
          ...
          {!advancedCustomGas ? <Text style={styles.message}>{strings('custom_gas.cost_explanation')}</Text> : null}
