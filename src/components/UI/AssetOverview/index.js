...
import { renderFromTokenMinimalUnit, balanceToFiat, renderFromWei, weiToFiat, hexToBN } from '../../../utils/number';
    ...
    return (
      <View style={styles.wrapper}>
        ...
        <AssetActionButtons
          ...
          middleText={strings('asset_overview.receive_button')}
