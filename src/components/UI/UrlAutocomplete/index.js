...
import dappUrlList from '../../../utils/dapp-url-list';
...
/**
 * React.Component that renders an autocomplete
 * based on an input string
 */
class UrlAutocomplete extends React.Component {
  static propTypes = {
		/**
