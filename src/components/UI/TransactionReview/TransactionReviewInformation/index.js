...
import { getTicker, getNormalizedTxState } from '../../../../utils/transactions';
 ...
 */
class TransactionReviewInformation extends React.Component {
  static propTypes = {
		/**
      ...
      <View style={styles.overview}>
        ...
        {!!amountError && (
          <View style={styles.overviewAlert}>
            <Icon name={'error'} size={20} style={styles.overviewAlertIcon} />
...
}))(observer(TransactionReviewInformation))
