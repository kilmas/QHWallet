...
import { renderFromTokenMinimalUnit } from '../../../utils/number';
...
/**
 * React.Component that renders watch asset content
 */
class WatchAssetRequest extends React.Component {
  static propTypes = {
		/**
