...
} from '../../../utils/custom-gas';
import { fromWei, renderWei, hexToBN } from '../../../utils/number';
      ...
      <View style={styles.selectors}>
        ...
        >
          <View style={styles.titleContainer}>
            ...
            <View style={styles.radio}>
              <Radio checked={gasAverageSelected} />
            </View>
          </View>
